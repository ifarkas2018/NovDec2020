        ...
        <%
            ...
            try {
                ...
                if (fillIn.equalsIgnoreCase("false")) { 
                    ...
                    if (prev_title.length() > AquaMethods.TITLE_LEN) {  
                        prev_title = prev_title.substring(0, AquaMethods.TITLE_LEN); // in the DB is written only first TITLE_LEN characters
                    }
                    ...
                    if (prev_auth.length() > AquaMethods.AUTHOR_LEN) {  
                        prev_auth = prev_auth.substring(0, AquaMethods.AUTHOR_LEN); // in the DB is written only first AUTHOR_LEN characters
                    }
                    ...
                    if (prev_isbn.length() > AquaMethods.ISBN_LEN) {  
                        prev_isbn = prev_isbn.substring(0, AquaMethods.ISBN_LEN); // in the DB is written only first ISBN_LEN characters
                    }
                ...
                if (rs.next()) {
                    ...
                    if (source1.equalsIgnoreCase("Delete Book")) {
                        ...
                        sTitle = "Delete Book"; // used for passing the title from one JSP script to the other
