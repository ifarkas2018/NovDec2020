...
<html>
    ...
    <body> 
        <%
            ...
            HttpSession hSess = AquaMethods.returnSession(request);
            // is the error page shown 
            is_attr_found = AquaMethods.sessVarExists(hSess, "is_error"); // sessVarExists: returns whether the session var. is_error exists in the session
                                        ...
                                        <form action="SubscrServl" method="post"> 
                                            <div class="row"> <!-- adding a new row the grid -->
                                                <div class="col">
                                                    ...
                                                    %>
                                                            ...
                                                            <input class="form-control form-control-sm" name="subscr_email" id="subscr_email" id="subscr_email" type="text" placeholder="Email" onfocusout='lengthLessMax("subscr_email", "email_msg")' required>
                                                            <span id="email_msg" class="text_size text-danger"></span>
                                                    <%
                                                        } else { // an error occurred - the inpuut field is diasabled
                                                    %>
                                                            <!-- input element used for entering the email; form-control-sm is used for smaller size of the input element -->
                                                            <input class="form-control form-control-sm" name="subscr_email" id="subscr_email" id="subscr_email" type="text" placeholder="Email" required disabled>
                                                    <%
                                                        }
                                                    %>
                                                </div>
                                            ...
                                            <div class="row"> <!-- adding a new row the grid -->
                                                <div class="col">
                                                    ...
                                                    %>
                                                         <button type="submit" class="btn btn-info btn-sm" id="btnSubscr" onclick="createCookie()" disabled>Subscribe</button>
                                                    <%
                                                        } 
                                                    %>
                                                </div>
