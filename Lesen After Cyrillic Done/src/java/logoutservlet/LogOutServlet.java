...
public class LogOutServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Lesen - Ausmelden</title>");            
            out.println("</head>");
            out.println("<body>");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        String sTitle = "Ausmelden"; // used for passing the title to the JSP script
        String sMessage = "SUCC_LOGOUT"; // used for passing the message to the JSP script	 
        hSession.setAttribute("source_name", "Ausmelden"); // on which page I am now
