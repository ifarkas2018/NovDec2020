...
public class DelServlet extends HttpServlet {
    ...
    private String delete(HttpSession hSession) {
        ...
        try {
            ...
            prev_author = LesenMethoden.deleteSpaces(prev_author);
            ...
            hSession.setAttribute("source_name", "Buch Löschen"); // on which page I am now
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        response.setContentType("text/html;charset=UTF-8");
        HttpSession hSession = LesenMethoden.returnSession(request); // hSession - used to store the information about that user
        String returnStr = delete(hSession);       
        
        String sTitle = "Buch Löschen"; // used for passing the title from one JSP script to the other
