 ...
 * project : Lesen
 * Mitarbeiter.java : for the URL: http://localhost:80880/Lesen/Mitarbeiter loads the web page index.jsp with the link for Login (employees or administrators)
 */
...
public class Mitarbeiter extends HttpServlet {
