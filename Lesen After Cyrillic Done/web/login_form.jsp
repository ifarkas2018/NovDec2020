...
<html>
    <head>
        ...
        <script>
            ...
            // setCookie: creates cookie input0 = value in the input field ; 
            function setCookie() {           
                var i;
                document.cookie = "input0=" + encodeURIComponent(document.getElementById("username").value) + ";"; // creating a cookie
            }
                    ...
                    <div class="container"> <!-- adding the container to the Bootstrap grid -->
                        <div class="row"> <!-- adding a new row to the Bootstrap grid -->
                            <div class="col">
                                &nbsp; &nbsp;
                                <br />
                                <h3 class="text-info">Anmelden</h3> <!-- title on the web page -->
                                <br /> 
                                    ...
                                    <div class="form-group">
                                        <%  
                                            ...
                                            if (LesenMethoden.sessVarExists(hSession, "fill_in")) { 
                                                ...
                                                if (LesenMethoden.sessVarExists(hSession, "page_name")) { 
                                                    ...
                                                    if ((page_name.equalsIgnoreCase(PAGE_NAME)) && (fill_in.equalsIgnoreCase("true"))) {
                                                        if (LesenMethoden.sessVarExists(hSession, "input0")) {
                                                        ...
                                                        LesenMethoden.setToEmptyInput(hSession); // setToEmpty: set the session variable values to "" for the variables named input0, input1, ...
                                                    }
                                                }
                                        ...
                                        <input type="text" class="form-control form-control-sm" name="username" id="username" onchange="setCookie()" onfocusout='setFocus("login", "username")' required value = "<%= input0 %>" > 
                                        <label class="text_size text-danger">* Pflichtfeld</label>
                                    </div>
                                        
                                    <!-- creating the input element for the password -->
                                    <div class="form-group">
                                        <label for="passw">Passwort</label> <!-- password name label -->
