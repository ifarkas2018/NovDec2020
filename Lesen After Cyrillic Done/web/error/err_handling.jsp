<%-- 
    ...
    Created on : 16-Feb-2020, 12:07:46
                    ...
                    <div class="container"> <!-- adding the container to the Bootstrap grid -->
                        <div class="row"> <!-- adding a new row to the Bootstrap grid -->
                            <div class="col">
                                ...
                                <br /><br /><br />
                                <br />
                                <h3 class="text-info">Lesen</h3> <!-- title on the web page -->
                                <br />
                                Die aufgerufene Seite kann gerade nicht angezeigt werden.
                                <br />
                                <br />
                                Bitte haben Sie ein wenig Geduld und <span class="text-warning">versuchen es später </span>noch einmal.
                                <br />
                                <br />
                                <br />
                            </div>
